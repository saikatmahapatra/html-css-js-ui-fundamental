<!DOCTYPE html>
    <head>
		...
		<link href="<?php echo base_url('assets/vendors/select2/dist/css/select2.css');?>" rel="stylesheet">
    ...
    <body data-controller="<?php echo $this->router->class; ?>" data-method="<?php echo $this->router->method; ?>">
		...
		<script src="<?php echo base_url('assets/vendors/datatables.net-bs4/js/dataTables.bootstrap4.js'); ?>"></script>		<!-- Bootstrap4 DataTables JavaScript -->
